...
export default function CareerLoading() {
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="p-6 border border-[rgba(255,255,255,0.06)] bg-[#151515] rounded-[14px] flex justify-between items-center">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        {[...Array(2)].map((_, i) => (
          <div key={i} className="p-8 border border-[rgba(255,255,255,0.06)] bg-[#151515] rounded-[14px] space-y-4">
